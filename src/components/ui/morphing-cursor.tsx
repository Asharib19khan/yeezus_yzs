...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-3xl md:text-5xl font-bold tracking-tighter text-white tracking-wide">{text}</span>

      <div
        ref={circleRef}
        className="absolute top-0 left-0 pointer-events-none rounded-full bg-white overflow-hidden z-20"
        style={{
      ...
      >
        ...
        >
          <span className="text-3xl md:text-5xl font-bold tracking-tighter text-black whitespace-nowrap tracking-wide">
            {hoverText}
          </span>
        </div>
      </div>
